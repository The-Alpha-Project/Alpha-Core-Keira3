...
describe('CreatureSpawn integration tests', () => {
  ...
  describe('Creating new', () => {
    ...
    it('should correctly initialise', () => {
      ...
      expect(page.getInputById('spawn_id').disabled).toBe(true);
      ...
      expect(page.getInputById('spawntimesecsmin').disabled).toBe(true);
      expect(page.getInputById('spawntimesecsmax').disabled).toBe(true);
      expect(page.getInputById('wander_distance').disabled).toBe(true);
      expect(page.getInputById('health_percent').disabled).toBe(true);
      expect(page.getInputById('mana_percent').disabled).toBe(true);
      expect(page.getInputById('movemen_type').disabled).toBe(true);
      expect(page.getInputById('spawn_flags').disabled).toBe(true);
